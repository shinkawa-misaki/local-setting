# ===============================================================
# Infinity フレームワークのオブジェクト指向機能（OO ブートストラップ）を使い、
# 「配列（array）」という独自の型に対して多彩なメソッド群を定義
# Bash 上で this という配列オブジェクトを操作できるようにしている
#
# 問題点：
# Map モジュールがまだ整備されておらず、Array モジュールにだけ定義が残っているため、呼び出し箇所が見当たらない
# these three are same as map - make map extend array and merge in the future：まだマージされていない。。
# ===============================================================

import util/namedParameters
import util/type Array
